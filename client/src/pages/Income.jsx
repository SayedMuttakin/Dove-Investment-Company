                        ...
                        <div className="flex items-start gap-2 mb-4">
                            ...
                            <div className="mt-1">
                                ...
                                <span className="text-sm font-bold text-gray-900 dark:text-white block">
                                    ...
                                    {incomeData.totalClaimable > 0 && <span className="text-black !text-black dark:text-white dark:!text-white ml-1">(${incomeData.totalClaimable.toFixed(2)})</span>}
                                </span>
                            </div>
                        </div>
                        <button
                        ...
                        <div className="flex items-start gap-2 mb-4">
                            ...
                            <div className="mt-1">
                                ...
                                <span className="text-sm font-bold text-gray-900 dark:text-white block">
                                    ...
                                    {teamBenefits.totalAmount > 0 && <span className="text-black !text-black dark:text-white dark:!text-white ml-1">(${teamBenefits.totalAmount.toFixed(2)})</span>}
                                </span>
                            </div>
                        </div>
                        <button
